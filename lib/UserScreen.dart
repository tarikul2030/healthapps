              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      DataValue(
                        data: "${_caloriesburned} Centigrade",
                        dataIcon: Icons.thermostat,
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              Prediction(patientInfo.ageOn!, patientInfo.sex!, patientInfo.chestPain!, _bp_s!, patientInfo.lipid!, patientInfo.fbs!, patientInfo.ecg!, _aiheart_rate!, patientInfo.exercise!, patientInfo.oldpeak!, patientInfo.slope!, patientInfo.ca!, patientInfo.thal! )));
                },
              ),
              SizedBox(
                height: 30,
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              Predictiond(patientInfo.step_count!, patientInfo.mood!, patientInfo.calories_burned!, patientInfo.hours_of_sleep!, patientInfo.weight_kg! )));
                },
              ),
              SizedBox(
                height: 30,
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              Predictiondi(patientInfo.ageOn!, patientInfo.sex!, patientInfo.familyDiabetes!, patientInfo.highBP!, patientInfo.PhysicallyActive!, patientInfo.BMI!, patientInfo.Smoking!, patientInfo.Alcohol!, patientInfo.hours_of_sleep!, patientInfo.SoundSleep!, patientInfo.RegularMedicine!, patientInfo.JunkFood!,patientInfo.Stress!, patientInfo.BPLevel!, patientInfo.Pregancies!,patientInfo.Pdiabetes!, patientInfo.UriationFreq! )));
                },
              ),
